...
import { CreateTableBodyType, CreateTableBody } from '@/zusstand/table/table.schema'
import { useAddTableMutation } from '@/zusstand/table/table-client-controler'
...
export default function AddTable() {
  ...
  const onSubmit = async (values: CreateTableBodyType) => {
    ...
    try {
      ...
      toast({
        description: "successful create table"
      })
      reset()
      setOpen(false)
    } catch (error) {
